...
if [ "$(docker ps -a | grep ${CONTAINER_NAME})" ]; then
    ...
    HOME_OPTIONS+=" -v "$WORKING_FOLDER_TO_MOUNT_IN_CONTAINER":"/workspace/pyslam":rw"
    ...
    MOUNT_OPTIONS=""
    # if [[ "$OSTYPE" == "linux"* ]]; then 
    #     MOUNT_OPTIONS="-v /home/puneeth/Desktop/projects/gdftt/data:/workspace/data -v /mnt:/mnt -v /dev:/dev"  # not working under macOS
    # fi 
